...
export default class ActorSheet5eVehicle extends ActorSheet5e {
  ...
  _computeEncumbrance(totalWeight, actorData) {
    ...
    totalWeight /= game.settings.get("genefunk2090", "metricWeightUnits")
      ? CONFIG.GENEFUNK2090.encumbrance.vehicleWeightMultiplier.metric
      : CONFIG.GENEFUNK2090.encumbrance.vehicleWeightMultiplier.imperial;
  ...
  _prepareCrewedItem(item, context) {
    ...
    context.toggleTitle = game.i18n.localize(`GENEFUNK2090.${isCrewed ? "Crewed" : "Uncrewed"}`);

    // Handle crew actions
    if ( item.type === "feat" && item.system.activation.type === "crew" ) {
      context.cover = game.i18n.localize(`GENEFUNK2090.${item.system.cover ? "CoverTotal" : "None"}`);
  ...
  _prepareItems(context) {
    const cargoColumns = [{
      label: game.i18n.localize("GENEFUNK2090.Quantity"),
      css: "item-qty",
      property: "quantity",
      editable: "Number"
    }];
    ...
    const equipmentColumns = [{
      ...
      label: game.i18n.localize("GENEFUNK2090.AC"),
      css: "item-ac",
      property: "system.armor.value"
    }, {
      label: game.i18n.localize("GENEFUNK2090.HP"),
      css: "item-hp",
      property: "system.hp.value",
      editable: "Number"
    }, {
      label: game.i18n.localize("GENEFUNK2090.Threshold"),
      css: "item-threshold",
      property: "threshold"
    }];
    ...
    const features = {
      actions: {
        label: game.i18n.localize("GENEFUNK2090.ActionPl"),
        items: [],
        hasActions: true,
        crewable: true,
      ...
      passive: {
        label: game.i18n.localize("GENEFUNK2090.Features"),
        items: [],
        dataset: {type: "feat"}
      },
      reactions: {
        label: game.i18n.localize("GENEFUNK2090.ReactionPl"),
        items: [],
    ...
    const cargo = {
      crew: {
        label: game.i18n.localize("GENEFUNK2090.VehicleCrew"),
      ...
      passengers: {
        label: game.i18n.localize("GENEFUNK2090.VehiclePassengers"),
      ...
      cargo: {
        label: game.i18n.localize("GENEFUNK2090.VehicleCargo"),
        items: [],
        dataset: {type: "loot"},
        columns: [{
          label: game.i18n.localize("GENEFUNK2090.Quantity"),
          ...
          label: game.i18n.localize("GENEFUNK2090.Price"),
          css: "item-price",
          property: "system.price.value",
          editable: "Number"
        }, {
          label: game.i18n.localize("GENEFUNK2090.Weight"),
          css: "item-weight",
