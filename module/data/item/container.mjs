 ...
 * @property {string} capacity.type         Method for tracking max capacity as defined in `GENEFUNK2090.itemCapacityTypes`.
    ...
    return this.mergeSchema(super.defineSchema(), {
      capacity: new foundry.data.fields.SchemaField({
        type: new foundry.data.fields.StringField({
          required: true, initial: "weight", blank: false, label: "GENEFUNK2090.ItemContainerCapacityType"
        }),
        value: new foundry.data.fields.NumberField({
          required: true, min: 0, label: "GENEFUNK2090.ItemContainerCapacityMax"
        }),
        weightless: new foundry.data.fields.BooleanField({required: true, label: "GENEFUNK2090.ItemContainerWeightless"})
      }, {label: "GENEFUNK2090.ItemContainerCapacity"})
    });
  }
}
