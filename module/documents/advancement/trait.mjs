...
export default class TraitAdvancement extends Advancement {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      ...
      order: 30,
      icon: "systems/genefunk2090/icons/svg/trait.svg",
      title: game.i18n.localize("GENEFUNK2090.AdvancementTraitTitle"),
      hint: game.i18n.localize("GENEFUNK2090.AdvancementTraitHint"),
      apps: {
        config: TraitConfig,
        flow: TraitFlow
      }
  ...
  sortingValueForLevel(levels) {
    const traitOrder = Object.keys(CONFIG.GENEFUNK2090.traits).findIndex(k => k === this.representedTraits().first());
    const modeOrder = Object.keys(CONFIG.GENEFUNK2090.traitModes).findIndex(k => k === this.configuration.mode);
  ...
  async actorSelected() {
    ...
    const traitTypes = this.configuration.mode === "default" ? Object.keys(CONFIG.GENEFUNK2090.traits)
      : filteredKeys(CONFIG.GENEFUNK2090.traits, t => t.expertise);
  ...
  async availableChoices(chosen) {
    ...
    if ( this.configuration.allowReplacements && (unfilteredLength > available.length) ) {
      ...
      return {
        ...
        label: game.i18n.format("GENEFUNK2090.AdvancementTraitChoicesRemaining", {
