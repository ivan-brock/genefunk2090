 ...
 * (e.g. "genefunk2090.actor-traits").
 * @returns {Promise}
 */
export async function preloadHandlebarsTemplates() {
  const partials = [
    // Shared Partials
    "systems/genefunk2090/templates/actors/parts/active-effects.hbs",
    "systems/genefunk2090/templates/apps/parts/trait-list.hbs",

    // Actor Sheet Partials
    "systems/genefunk2090/templates/actors/parts/actor-traits.hbs",
    "systems/genefunk2090/templates/actors/parts/actor-inventory.hbs",
    "systems/genefunk2090/templates/actors/parts/actor-features.hbs",
    "systems/genefunk2090/templates/actors/parts/actor-spellbook.hbs",
    "systems/genefunk2090/templates/actors/parts/actor-warnings.hbs",

    // Item Sheet Partials
    "systems/genefunk2090/templates/items/parts/item-action.hbs",
    "systems/genefunk2090/templates/items/parts/item-activation.hbs",
    "systems/genefunk2090/templates/items/parts/item-advancement.hbs",
    "systems/genefunk2090/templates/items/parts/item-description.hbs",
    "systems/genefunk2090/templates/items/parts/item-mountable.hbs",
    "systems/genefunk2090/templates/items/parts/item-spellcasting.hbs",
    "systems/genefunk2090/templates/items/parts/item-source.hbs",
    "systems/genefunk2090/templates/items/parts/item-summary.hbs",

    // Journal Partials
    "systems/genefunk2090/templates/journal/parts/journal-table.hbs",

    // Advancement Partials
    "systems/genefunk2090/templates/advancement/parts/advancement-ability-score-control.hbs",
    "systems/genefunk2090/templates/advancement/parts/advancement-controls.hbs",
    "systems/genefunk2090/templates/advancement/parts/advancement-spell-config.hbs"
  ];

  const paths = {};
  for ( const path of partials ) {
    paths[path.replace(".hbs", ".html")] = path;
    paths[`genefunk2090.${path.split("/").pop().replace(".hbs", "")}`] = path;
  }
...
function itemContext(context, options) {
  if ( arguments.length !== 2 ) throw new Error("#genefunk2090-itemContext requires exactly one argument");
...
export function registerHandlebarsHelpers() {
  Handlebars.registerHelper({
    ...
    "genefunk2090-groupedSelectOptions": groupedSelectOptions,
    "genefunk2090-linkForUuid": linkForUuid,
    "genefunk2090-itemContext": itemContext
  });
}
 ...
 * @param {string} configKeyPath          Key path within `CONFIG.GENEFUNK2090` to localize.
 * @param {object} [options={}]
 ...
 * @param {object} config  The `CONFIG.GENEFUNK2090` object to localize and sort. *Will be mutated.*
 */
